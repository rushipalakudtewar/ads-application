...
const MediaAdsFill = () =>{
    ...
    return (
        <div>
            <div className="m-4 p-2 border-2 h-[105vh] rounded-lg shadow-md">
                <h1 className="ml-5 text-xl">Create Text & Media</h1>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mx-2 p-3 ">
                    <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mx-2 p-3 ">
                        <div>
                            <label>Bussiness Name</label><br/>
                            <input type="text" className="w-full lg:w-[21.5rem] border rounded-md mt-2 p-1" placeholder="add a heading1"/>
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 gap-1 mx-2 p-3 ">
                    <div>
                        <label>Website URL</label><br/>
                        <input type="text" className="w-full lg:w-[74rem] border rounded-md mt-2 p-1" placeholder="add a heading1"/>
                    </div>
                    </div>
                    
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 mx-2 p-3">
                    <div>
                        <label>Bussiness Name</label><br/>
                        <input type="text" className="w-full lg:w-[35rem] border rounded-md mt-2 p-1" placeholder="add a heading1"/>
                    </div>
