...
const TextAdsFill = () =>{
    ...
    return (
        <div>
            <div className="m-4 p-2 border-2 h-[82vh] rounded-lg relative shadow-md">
                ...
                <div className="grid grid-cols-2 gap-3 m-2 p-3 ">
                    ...
                    <div>
                        ...
                        <input type="text" className="w-[74.7rem] border rounded-md mt-2 p-1" placeholder="add a heading1"/>
                    </div>
                </div>
